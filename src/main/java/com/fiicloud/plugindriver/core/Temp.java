...
public class Temp {
    ...
    static {
        ...
        springIOCAnnotations.add(Configuration.class);
    }
    ...
    public Temp jarLibPath(String path) {
        this.setJarLibPath(path);
        return this;
    }

    public Temp ymlPath(String path) {
        this.setRelationYml(path);
        return this;
    }

    public Temp annotations(Class... annotations) {
    ...
    public Plugin.PluginBuilder loadOrder(){
    ...
    public static void main(String[] args) {
        Plugin plugin = Plugin.builder().id("a").name("dsad").build();
    }
